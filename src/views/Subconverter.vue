  ...
  data() {
    return {
      ...
      options: {
        ...
        customBackend: {
        "jueson后端": "https://sub.wdz.de5.net",
      ...
      form: {
        sourceSubUrl: "",
        clientType: "",
        customBackend: this.getUrlParam() == "" ? "https://sub.wdz.de5.net" : this.getUrlParam(),
        shortType: "https://v1.mk/short",
        remoteConfig: "https://raw.githubusercontent.com/cmliu/ACL4SSR/main/Clash/config/ACL4SSR_Online_Full_MultiMode_CF.ini",
        excludeRemarks: "",
        includeRemarks: "",
        filename: "",
        rename: "",
